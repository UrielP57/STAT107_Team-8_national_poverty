...
life_x2 <- glm(Poverty_rate ~ Inflation + Population + Unemployment + `Education % from GDP`, data = df_ND)
life_v3 <- glm(Poverty_rate ~ Inflation + Population + Unemployment + `Education % from GDP` + poly(Time, 2), data = df_ND)
life_m7 <- glm(Poverty_rate ~ Inflation + Population + Unemployment + `Education % from GDP` + poly(Time, 3), data = df_ND)
stargazer(life, life_x2,life_v3,life_m7,
